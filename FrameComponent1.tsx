  ...
  return (
    ...
    >
      ...
      <div className="self-stretch w-[255px] hidden flex-col items-center justify-start gap-[24px]">
        <img className="w-20 h-20 relative" alt="" src="/icon-13.svg" />
      ...
      <div className="self-stretch w-[255px] hidden flex-col items-center justify-start gap-[24px]">
        <img className="w-20 h-20 relative" alt="" src="/icon-14.svg" />
        <div className="self-stretch flex-1 flex flex-col items-center justify-start gap-[8px]">
          <b className="self-stretch h-[26px] relative leading-[120%] inline-block mq975:text-lg mq975:leading-[21px]">
            Quality Guarantee
          </b>
      ...
      <Content
        icon="/icon-15.svg"
        customerSupport="Free Delivery"
        weHaveAOfComputerExpertRe="The slept control by first be right, and left men's own tin, without at the in project"
        propPadding="unset"
      />
    </div>
  );
